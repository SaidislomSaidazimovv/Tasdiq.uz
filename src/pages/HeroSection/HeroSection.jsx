        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-2xl">
            ...
            >
              ...
              <a href="#how-it-works" className="px-8 py-4 bg-white text-gray-900 text-lg font-semibold rounded-xl border-2 border-gray-200 hover:border-gray-300 transition-all duration-300">
                Qanday ishlaydi?
              </a>
            </div>
            <div
